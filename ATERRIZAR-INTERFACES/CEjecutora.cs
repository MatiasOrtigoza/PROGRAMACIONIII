...
namespace ATERRIZAR_INTERFACES
{
    internal class CEjecutora
    {
        static int TamañoVector = 2;
        ...
        static void Main(string[] args)
        {
            ...
            Console.Write($"\nCANTIDAD DE VIAJES A ANOTAR: {TamañoVector}\n");
            ...
            Console.Write("\nLISTA DE VIAJES (SIN ORDENAR)" + MostrarViajes(VectorViajes));
            Array.Sort(VectorViajes);
            Console.Write("\n\nLISTA DE VIAJES (ORDENADOS POR PRECIO)" + MostrarViajes(VectorViajes));
            Array.Reverse(VectorViajes);
            Console.Write("\n\nLISTA DE VIAJES (REVERSED)" + MostrarViajes(VectorViajes));
            Console.ReadKey();
        ...
        static string MostrarViajes(CViaje[] Vector)
        {
            string Datos = "";

            foreach(CViaje Viaje in Vector)
            {
                Datos = Datos + Viaje.DarDatos();
            }
