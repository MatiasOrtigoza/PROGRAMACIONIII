...
namespace CLASE10_PERSONA
{
    internal class Program
    {
        ...
        public static void CargarAlumnos()
        {
            ...
            Interfaz.Mensaje("¿Desea guardar los alumnos cargados?\n1. Si\n2. No\nOpcion: ");
            int Opcion = int.Parse(Console.ReadLine());

            if(Opcion == 1)
            {
                string path = "C:/Users/xxwan/Documents/FACULTAD/TERCER CUATRIMESTRE/PROGRAMACION III/repositorio-ejercicios/PROGRAMACIONIII/CLASE11-PERSONA-ARCHIVO/data/alumnos.csv";
                Interfaz.Mensaje(Controlador.GuardarAlumnosCSV(path));
                Interfaz.Pause();
            }
